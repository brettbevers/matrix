...
first_five_squares = { i**2 for i in {1,2,3,4,5} }
...
representation_dict = { n:(n//base**2, (n%base**2)//base, n%base) for n in range(1000) if n%base in digits and (n%base**2)//base in digits and n//base**2 in digits }
